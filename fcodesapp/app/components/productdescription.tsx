          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="flex items-center mb-4">
              ...
              <span className="text-sm text-zinc-500 dark:text-zinc-400 line-through">
                {Number(products[0].sellingprice) + 3000}
              </span>
            </div>
            <div className="mb-6">
              ...
              <select
                id="size"
                name="size"
                className="block w-full p-2 border border-zinc-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
              >
            ...
            <div className="flex items-center">
              <a
                href="#"
                className="text-zinc-600 dark:text-zinc-400 mr-4 hover:text-zinc-800 dark:hover:text-white"
              >
            ...
            <div className="flex items-center bg-slate-600 w-auto h-auto">
              <p> this is reviews</p>
            </div>
          </div>
        </div>
